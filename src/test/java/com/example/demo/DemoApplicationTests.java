...
class DemoApplicationTests {
	...
	@Order(2)
	void 로그인(){
//		worker = userController.login(userRepository.findUserByIdAndAuthType("01011111111","근로자"));
//		employer = userController.login(userRepository.findUserByIdAndAuthType("01055555555","고용주"));
	}
}
