...
public class ExceptionHandlerAdvice {
    ...
    //error :400번
    @ExceptionHandler({IDDuplicatedException.class, IDNotExistException.class, PWMissMatchException.class,MessageVarificationFailed.class,FinishTimeException.class,StartTimeException.class})
